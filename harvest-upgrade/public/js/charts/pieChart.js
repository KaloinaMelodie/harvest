const dataset = [5, 7, 3, 6, 8, 4.5, 2, 4, 5, 4];
...
// green = ['#79f436,#6ad62f,#5bb729,,#4c9922,#3c7a1b,#2d5b14,#1e3d0e,#0f1e07'];

// const green = ["#79f436", "#6ad62f", "#5bb729", "#4c9922", "#3c7a1b", "#2d5b14", "#1e3d0e", "#0f1e07"];
...
let draw = function () {
    ...
    slice
        ...
        .append("path")
        .attr({
            fill: (d, i) => sector[i],  // change the color fill here
            d: arc,
            "stroke-width": "25px",
    ...
    text
        ...
        .attr("dy", "0.35em")
        .style("opacity", 0)
        .style("fill", (d, i) => sector[i])
        .text((d, i) => labels[i])  // change the label here
        .attr("transform", (d) => {
